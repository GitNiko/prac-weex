...
//}
//
//RCT_REMAP_METHOD(openUri, resolver:(RCTPromiseResolveBlock)resolve
//                 rejecter:(RCTPromiseRejectBlock)reject) {
//    [Navigation openUri:@"ssd" resolve:resolve reject:reject];
//}
//
...
RCT_EXTERN_METHOD(pop: (NSDictionary*)param animated)

RCT_EXTERN_METHOD(push: (NSDictionary*)parm animated)
